...
- [HV](api/hv/overview.md)
    - [Common Utilities](api/hv/common.md)
        ...
        - [Domain](api/hv/common/domain.md)
        - [Pod](api/hv/common/pod.md)
...
- [Memory](api/memory/overview.md)
    ...
    - [Substrate & Views](api/memory/substrate.md)
    - [Selectors](api/memory/selectors.md)
        - [Near-Neighbor Search](api/memory/selectors/near_neighbor.md)
        - [Attractors](api/memory/selectors/attractors.md)
